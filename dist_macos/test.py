...
def main():
    a=argparse.ArgumentParser(); a.add_argument('--data',default='data_free.npz'); a.add_argument('--versions',type=int,default=280); a.add_argument('--writes',type=int,default=8); a.add_argument('--write-bytes',type=int,default=256); a.add_argument('--seed',type=int,default=20260811); a.add_argument('--require-traffic-x',type=float,default=250.0); x=a.parse_args()
