...
On sparse incremental file-update workloads, HKD Socket was measured end-to-end at 4.54× faster on macOS and 3.60× faster on Linux versus repeatedly retransmitting full versions with standard Python socket.sendfile(), while preserving exact reconstruction.
